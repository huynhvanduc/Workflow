...
|---|-------------------|------------|
| 1 | Thời gian test tối thiểu bắt buộc: cần xác nhận con số cụ thể (7 ngày? 14 ngày?) | Cần chốt |
| 2 | Có cho phép admin rút ngắn thời gian test trong trường hợp khẩn không? | Cần chốt |
| 3 | Khi DEACTIVATE khẩn cấp, hồ sơ đang xử lý dở xử lý thế nào? | Cần chốt |
