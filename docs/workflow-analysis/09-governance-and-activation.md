...
| 4 | Workflow bị deactivate khẩn cấp khi có hồ sơ đang xử lý dở | Trung bình | Có hướng dẫn xử lý hồ sơ dở; không tự động hủy hồ sơ |
...
|---|---------|----------------|
| 1 | Thời gian thử nghiệm tối thiểu mặc định là bao lâu? Admin có được cấu hình không? | Cao |
| 2 | Ai có quyền DEACTIVATE khẩn cấp workflow đang ACTIVE? Cần approval flow không? | Cao |
| 3 | Hồ sơ đang dở khi deactivate khẩn cấp: tự động hủy, giữ nguyên, hay cần admin xử lý từng cái? | Cao |
| 4 | Có cần bước phê duyệt từ cấp trên trước khi admin được publish không? | Trung bình |
| 5 | Audit log cần lưu bao lâu? Có quy định pháp lý nào liên quan không? | Trung bình |
